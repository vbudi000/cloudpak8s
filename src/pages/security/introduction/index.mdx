...
The IBM Cloud Pak for Security platform uses an infrastructure-independent 
...
IBM Cloud Pak for Security can connect disparate data sources—to uncover 
...
More information about IBM Cloud Pak for Security can be found at this
[IBM Knowledge Center](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/scp-core/overview.html)
page.

IBM Cloud Pak for Security 1.2.0 includes the following component
applications.

## Data Explorer

IBM® Security Data Explorer is a platform application that enables 
...
- Federated data search to unite silos of security data and provide 
...
- Single, unified interface and workflow to investigate threats and 
Indicators of Compromise into user-selected data sources
- In-context data enhancements from connected asset and risk data sources 
and IBM® Threat Intelligence Insights
- Workflows to track, append, create security cases from native platform 
case management system

For more information, see the 
[Data Explorer](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/data-explorer/overview.html?view=kc)
section of the IBM Knowledge Center.

## Cases

Cases for IBM Cloud Pak for Security provides organizations with the 
...
[Cases](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/orchestrated-response-scp/overview.html?view=kc).

## IBM Threat Intelligence Insights

IBM Threat Intelligence Insights is an application that delivers unique, 
...
- IBM-derived threat intelligence across threat activity, threat groups, 
malware, and industries
- Continuous and automated *Am I Affected* searches across connected data 
sources to proactively identify your most relevant threats
- Analytical and adaptive threat scoring to help prioritize threats for 
further investigation and response

For more information, see 
[IBM Threat Intelligence Insights](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/threat-intelligence-insights/overview.html?view=kc).

**Note:** The IBM Threat Intelligence Insights application is installed 
by default, but can be switched off as part of the IBM Cloud Pak for 
Security installation process.
...
- Create response plans that are based on industry standards and best 
practices.
- Integrate more easily with security and IT tools, and orchestrate 
responses to events and incidents.
- Collaborate across the organization, equipping various stakeholders 
with the tools to fulfill their roles and tasks as part of an incident 
response effort.

For more information, see 
[IBM Resilient Security Orchestration, Automation, and Response (SOAR) Platform](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/resilient.html?view=kc).

## IBM QRadar Security Intelligence Platform

IBM® QRadar® Security Intelligence Platform is offered as an on-premises 
...
activity, such as phishing, lateral movement, and data exfiltration.

For more information, see 
[QRadar Security Intelligence Platform ](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/qradar.html?view=kc).

The following diagram illustrates a high-level overview of the components 
of IBM Cloud Pak for Security.

![Overview diagram](https://www.ibm.com/support/knowledgecenter/SSTDPP_1.2.0/docs/scp-core/images/overview.png)