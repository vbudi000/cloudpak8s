...
![Overview](/assets/img/cp4a/apps-overview.png)
...
| Accelerators for Teams | [Install](../cp4a_installation) | Open source projects to build, deploy and run applications.  Installs into an OpenShift Container Platform cluster. |
