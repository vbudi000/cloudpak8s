...
7. Update `/etc/httpd/conf.d/manageiq-external-auth-openidc.conf`
...
9. Open the CloudForms Web UI and log in as `admin`, then select the Configuration by clicking the gear icon.
...
14. Select Access Control and make sure the user’s groups are created on the Appliance and appropriate roles assigned to those groups.
