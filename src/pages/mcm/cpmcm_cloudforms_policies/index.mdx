...
- Provider: managing the provider domain status:
    ...
    - Container provider RedHat OpenShift.
...
- Container Project: managing OpenShift namespaces
- Container Node: managing OpenShift nodes
- Container Image: managing OpenShift container images
- Replicator: managing OpenShift workload such as statefulset, daemonset, deployment, deploymentconfig, replicaset
- Pod: managing OpenShift pods
...
<br/>![Event action](/assets/img/cp4mcm/cf5_06_event.png)
7. Specify the actions on whether the condition is true or not. Click **Save** when done.
<br/>![Action policy](/assets/img/cp4mcm/cf5_07_action.png)
