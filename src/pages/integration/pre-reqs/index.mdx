...
- For this residency 11 worker nodes, each with 8 cores and 32 GB of memory 
were requested for the managed OCP instance
- For the on-prem vmware environment, we had a similar configuration with 11 
worker nodes and 2 storage nodes
