...
Begin by [deploying IBM Common Service by following these steps](http://localhost:8000/common_services/cs_install/) and then return here to continue deploying the Cloud Pak for Integration.
