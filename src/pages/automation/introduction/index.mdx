...
- [IBM Business Automation Navigator](/automation/install-ban)
- [IBM FileNet Content Manager](/automation/install-ecm)
- [IBM Automation Workstream Services](/automation/install-aws)
- [IBM Business Automation Content Analyzer](/automation/install-aca)
- [IBM Operational Decision Manager](/automation/install-odm)
- [IBM Automation Digital Worker](/automation/install-adw)

The install process is performed through an Operator, which configuration is described [here](/automation/install-operator)
...
- The [Digital business automation reference architecture](https://www.ibm.com/cloud/architecture/architectures/dba-architecture) in the IBM Architecture Center.
- The [Denim Compute DBA reference implementation](https://github.com/ibm-cloud-architecture/denim-compute) in GitHub.
- The [IBM Digital Business Automation Field Guide](https://www.ibm.com/cloud/architecture/content/field-guide/digital-business-automation-field-guide)
