...
description: OpenShift Day2 Personas
keywords: 'OpenShit, day2, persona'
---
...
![Figure 1](./images/Persona1.PNG "Figure 1")
...
![Figure 2](./images/Persona2.PNG "Figure 2")
...
![Figure 3](./images/Persona4.png "Figure 3")
...
However, many of these activities cannot be delegated as the sole responsibility of an Architect. Every member of the DevOps squad needs to embody these characteristics and take full accountability of their doing. At the same time, a key principle of DevOps and Lean is to embody _just enough architecture_. While the role of an Architect will never disappear completely, many of the tasks that were performed by the Architect in the past are now assumed by the DevOps members.
