---
title: OpenShift Platform Day2 - Supplement - Log on IBM Cloud
description: OCP Day2 Supplement Log
keywords: 'ocp, day2, supplement, log'
---
...
![ibmcloud_ocp_dashboard_pod_logs](/assets/img/day2/ibmcloud_ocp_dashboard_pod_logs.png)
...
![ibmcloud_efk_not_supported](/assets/img/day2/ibmcloud_efk_not_supported.png)  
...
![ibmcloud_logdna](/assets/img/day2/ibmcloud_logdna.png)

The sample output on the LogDNA dashboard is shown in below.  

![ibmcloud_logdna_dashboard](/assets/img/day2/ibmcloud_logdna_dashboard.png)
...
![ibmcloud_external_efk](/assets/img/day2/ibmcloud_external_efk.png)  
...
![ibmcloud_audit_log_activity_tracker](/assets/img/day2/ibmcloud_audit_log_activity_tracker.png)

Sample output of audit log events on the Activity Tracker dashboard is shown in below.  

![ibmcloud_activity_tracker_dashboard](/assets/img/day2/ibmcloud_activity_tracker_dashboard.png)
