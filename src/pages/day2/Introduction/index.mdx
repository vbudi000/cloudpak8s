...
description: OCP Day2 Introduction
keywords: 'ocp, day2, introduction'
---

# OCP-Day2-operations
A guide for post deployment Operations of Red Hat OpenShift (OCP - OpenShift Container Platform)

# Introduction

The purpose of this guide is to assist an organization with the operational aspects of Red Hat OpenShift (OCP - OpenShift Container Platform, to be precise) on Day-2. The premise of this document is to describe core principles/processes that should be taken on “day 2” where the journey is defined as:
...
As each new applications is added to the environment the OCP-based applications Day-0 through Day-2 is executed again. The personas involved in Application Day-0 would be Product Owners, DevOpsEngineer, SREs and Architects. Day-1 and Day-2 personas would include DevOps and SREs.
...
The Garage and Solution Engineering team has developed a Reference Architecture for OCP, discussing topics like Network, Storage, and Cluster Nodes. This architecture provides good background and context for the operational aspects of the OCP solution:
[OpenShift 4.x Cloud Reference Architecture](https://github.com/ncolon/ocp4-refarch)

The following chart depicts the Day-2 Reference Architecture for OCP: in the middle of the charts you see a OCP cluster with applications running on top of the standard resources compute, storage, and network. Left and right of the OCP cluster, you find the domains of Day-2 activities. On top you see the personas responsible for these activities.

![Figure 1](/assets/img/day2/Day2_ReferenceArchitecture.PNG "Figure 1")

### Bylaws
When describing Day-2 activities for OCP, it is relevant to define some *precepts* or *bylaws* that act as guiding principles for the definition and design of these activities:
* Immutable / Disposable Inftastructure 
...
# OCP Day2 Foundational Operational Aspects
...
![Figure 2](/assets/img/day2/Day2_FoundationalAspects.PNG "Figure 2")
...
# OCP Day2 Important Operational Aspects
...
![Figure 3](/assets/img/day2/Day2_ImportantAspects.PNG "Figure 3")
...
# OCP Day2 Additional Operational Aspects
...
![Figure 4](/assets/img/day2/Day2_AdditionalAspects.PNG "Figure 4")
...
Related work has been done for IBM Cloud Private (ICP): see https://github.ibm.com/CASE/ICP-DAY2-Operations

### Design Decisions

Throughout the development of this guide, several design decisions have been made. We document them here to not loose sight of these decisions.

- [ ] Personas - limited to SRE and DevOps Engineer/Developer
- [ ] Version links - send to OCP 4.3 documentation and not to latest
- [ ] Use the expression "Platform" instead of "Infrastructure" when discussing OCP and not the underlying VMs, etc...
- [ ] Make changes directly and not with "pull requests" 
